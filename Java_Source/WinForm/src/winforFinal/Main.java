...
import scoreGUI.ActionEventClass1;
...
public class Main {
	...
	public static void main(String[] args) {
		...
		ActionListener GraphEventimplementsB = new GraphEvent(num, table, dc);
		
		B_draw1.addActionListener(inserEventB);
		B_draw2.addActionListener(UpdataEventB);
		B_draw3.addActionListener(DeleteEventB);
		B_draw4.addActionListener(GraphEventimplementsB);
